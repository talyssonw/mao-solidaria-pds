        ...
        <div class="col-lg-3 col-md-3 hidden-sm hidden-xs">
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="media">
                        <div align="center">
                            <img class="thumbnail img-responsive" src="<?php echo $this->session->userdata('picture_url'); ?>" width="300px" height="300px">
                            <h3><strong><?php echo $this->session->userdata('name'); ?></strong></h3>
                        </div>
                        <div class="media-body">
                            ...
                            <p><?php echo $this->session->userdata('locale'); ?></p>
                            <hr>
                            <h3><strong>Gender</strong></h3>
                            <p><?php echo $this->session->userdata('gender'); ?></p>
                            <hr>
                            <h3><strong>Birthday</strong></h3>
                            <p><?php echo $this->session->userdata('birthday'); ?></p>
                        </div>
                    </div>
                </div>
            </div>
