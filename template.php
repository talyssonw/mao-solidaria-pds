    ...
    <div class="container-fluid">
      ...
      <div id="navbar9" class="navbar-collapse collapse">
        <ul class="nav navbar-nav navbar-left">
            <li>
                <a href="<?= base_url('appEntidadeController/call_search_proj_mainpage') ?>"  data-toggle="tooltip" title="Projetos">Projetos</a>
            </li>
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <?php }else{ ?>
                    <li><a href="<?= base_url('project-list/'.$this->session->userdata('id')); ?>">Meus Projetos <span class="badge pull-right"> 0 </span></a></li>
                    <li class="divider"></li>
                    <?php } ?>
...
<div class="col-sm-12" style="margin-top: 10%; background-color: #f2f2f2; border-top: solid #e6e6e6;">
    ...
    <!-- <footer style="margin-top:50px;"  class="container-fluid">           
        <br>
        <nav class="navbar navbar-inverse navbar-fixed-bottom" role="navigation">
            <div class="container" align="center">
                             <span class="input-group">
                                <a href="<?php echo base_url('login-admin'); ?>"   data-toggle="tooltip" title="Painel Administrativo" type="button" class="glyphicon glyphicon-lock"></a>
                             </span>
            </div>
        </nav>
    </footer> -->
